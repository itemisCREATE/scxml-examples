...
![image](ShallowHistory_0.png)

```xml
<?xml version="1.0" encoding="UTF-8"?>
<scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" datamodel="ecmascript" name="ShallowHistory">
	<state id="mainRegion">
		<initial>
		...
		<state id="State2">
			...
			<history type = "shallow" id="State2.entry_0">
			...
			<state id="State4">
				...
				<state id="State7">
					<initial>
						<transition target="State7.entry_0" type="internal" >
						</transition>
					</initial>
					<state id="State8">
					...
					<history type = "shallow" id="State7.entry_0">
						<transition   target="State8">
						</transition>
					</history>
